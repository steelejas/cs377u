...
function _hasDoNotTrackFlagOn(options) {
    if (options && options.respectDnt) {
        ...
        var nav = win === null || win === void 0 ? void 0 : win.navigator;
        var hasDntOn_1 = false;
        each([
            nav === null || nav === void 0 ? void 0 : nav.doNotTrack,
            nav['msDoNotTrack'],
            win['doNotTrack'],
        ], function (dntValue) {
...
function _optInOut(optValue, token, options) {
    ...
    options = options || {};
    _getStorage(options).set(_getStorageKey(token, options), optValue ? 1 : 0, isNumber(options.cookieExpiration) ? options.cookieExpiration : null, options.crossSubdomainCookie, options.secureCookie);
